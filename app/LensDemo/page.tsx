...
export function LensDemo() {
  // Track hovering state for each card separately
  const [hoveringStates, setHoveringStates] = useState([false, false]);
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial,index)=>(
            <div key={index} className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-[#1D2235] to-[#121318]">
              <Rays />
              <Beams />
              <div className="z-10">
                <Lens 
                  ...
                  setHovering={(value) => {
                    const newStates = [...hoveringStates];
                    newStates[index] = value;
                    setHoveringStates(newStates);
                  }}
                >
                  <Image
  ...
  return (
    ...
    >
      <g filter="url(#filter0_f_120_7473)">
        <circle cx="34" cy="52" r="114" fill="#f2f0f5" />
      </g>
      <g filter="url(#filter1_f_120_7473)">
        <circle cx="332" cy="24" r="102" fill="#8f8e90" />
      </g>
      <g filter="url(#filter2_f_120_7473)">
        <circle cx="191" cy="53" r="102" fill="#fcffc0" />
      </g>
      <defs>
        <filter
  ...
  return (
    ...
    >
      ...
      <defs>
        ...
        >
          <stop offset="0.214779" stopColor="#d9ea56" />
          <stop offset="0.781583" stopColor="#d9ea56" stopOpacity="0" />
        </linearGradient>
        <linearGradient
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#d9ea56" />
          <stop offset="1" stopColor="#d9ea56" stopOpacity="0" />
        </linearGradient>
        <linearGradient
